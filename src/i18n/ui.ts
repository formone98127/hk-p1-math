...
export const ui: Record<Locale, UiDict> = {
  en: {
    ...
    mixDesc: 'Test your skills with 10 random questions from every unit!',
    mixCount: '10 random',
    exit: '← Exit',
    questionOf: 'Question {a} of {b}',
    streak: '🔥 {n} streak',
    timeWarning: '⚠️ Only {t} remaining!',
    correctFeedback: '🌟 Amazing! You got it right!',
    wrongFeedback: '💪 Almost there! Keep trying!',
    nextIn: 'Next in {n}s...',
    hintToggle: '💡 Need a hint?',
    skip: 'Skip →',
    loading: 'Loading fun exercises...',
    resultsTitle: '🏆 You Did It! Super Star! ⭐',
    resultsScore: '{a} / {b} correct ({p}%)',
    resultsPoints: 'You earned {n} super points!',
    achievementsUnlocked: '🎉 New Badges Unlocked!',
    reviewAnswers: 'See Your Answers',
    correctStatus: '✓ Perfect!',
    yourAnswer: 'Your answer: {a}',
    skipped: 'Skipped',
    correctIs: 'The right answer: {a}',
    backToPractice: '🎯 Back to Practice',
    tryAgain: '🔄 Play Again',
    encouragement1: 'You are a math superstar! ⭐',
    encouragement2: 'Fantastic work! Keep it up! 🌟',
  ...
  'zh-Hant': {
    ...
    mixSection: '混合練習',
    mixTitle: '混合練習',
    mixDesc: '從所有單元隨機抽出 10 題來挑戰自己！',
    mixCount: '隨機 10 題',
    exit: '← 離開',
    questionOf: '第 {a} 題，共 {b} 題',
    streak: '🔥 連對 {n} 題',
    timeWarning: '⚠️ 只剩 {t}！',
    correctFeedback: '🌟 好棒！答對了！',
    wrongFeedback: '💪 差不多！再試一次！',
    nextIn: '再過 {n} 秒...',
    hintToggle: '💡 需要提示？',
    skip: '跳過 →',
    loading: '正在載入有趣題目...',
    resultsTitle: '🏆 你做到了！超級明星！⭐',
    resultsScore: '答對 {a} / {b} 題（{p}%）',
    resultsPoints: '你獲得 {n} 超級分數！',
    achievementsUnlocked: '🎉 解鎖新獎章！',
    reviewAnswers: '看看你的答案',
    correctStatus: '✓ 完美！',
    yourAnswer: '你的答案：{a}',
    skipped: '已跳過',
    correctIs: '正確答案：{a}',
    ...
    tryAgain: '🔄 再玩一次',
    encouragement1: '你是數學小天才！⭐',
    encouragement2: '做得好！繼續保持！🌟',
